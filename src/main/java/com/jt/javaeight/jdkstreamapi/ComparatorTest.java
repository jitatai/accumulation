...
public class ComparatorTest {
    ...
    public static void main(String[] args) {
        ...
        //list.stream().collect(Collectors.groupingBy(Person::getHeight,Collectors.groupingBy(Person::getAge))).values();
         ...
         */
        list.stream().sorted(Comparator.comparingInt(Person::getAge).thenComparingInt(Person::getHeight).reversed());
        list.stream().sorted(Comparator.comparing(Person::getAge,Comparator.reverseOrder()).thenComparing(Person::getHeight,Comparator.reverseOrder()));
    }
