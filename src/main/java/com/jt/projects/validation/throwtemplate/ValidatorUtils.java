package com.jt.projects.validation.throwtemplate;
...
public final class ValidatorUtils {
    ...
    public static void checkNull(Object param, String fieldName) {
        if (param == null) {
            throw new ValidationException(String.format(IS_EMPTY, fieldName));
        }
    }
    ...
    public static void checkId(Long id, String fieldName) {
        ...
        if (id < 0) {
            throw new ValidationException(String.format(LESS_THAN_ZERO, fieldName));
        }
    }
    ...
    public static void checkLength(String param, int min, int max, String fieldName) {
        ...
        if (length < min || length > max) {
            throw new ValidationException(String.format(LENGTH_OUT_OF_RANGE, fieldName, min, max));
        }
    }
    ...
    public static void checkMinLength(String param, int min, String fieldName) {
        ...
        if (param.length() < min) {
            throw new ValidationException(String.format(LENGTH_LESS_THAN, fieldName, min));
        }
    }
    ...
    public static void checkMaxLength(String param, int max, String fieldName) {
        ...
        if (param.length() > max) {
            throw new ValidationException(String.format(LENGTH_GREATER_THAN, fieldName, max));
        }
    }
    ...
    public static void checkPhone(String phone, String fieldName) {
        ...
        if (!matches) {
            throw new ValidationException(String.format(ILLEGAL_PARAM, fieldName));
        }
    }
